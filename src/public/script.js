...
$(function() {
  ...
  $('#serviceButton').click(function() {
    ...
    if (selectedCategory === 'Спецпредложение салона') {
      ...
      services = [
        'Окрашивание корней (до 2 см.) 30 гр. 2100 р. 2 ч.',
        'Окрашивание (в один тон/45 гр..) 2490 р. 2 ч.',
        'Окрашивание (в один тон/60 гр..) 2990 р. 2 ч.',
        'Окрашивание (в один тон/90 гр..) 3600 р. 2 ч.',
        'Тонирование (в один тон/45гр..) 2550р. 2 ч.',
        'Тонирование (в один тон/60гр..) 2650р. 2 ч.',
        'Тонирование (в один тон/90гр..) 3750р. 2 ч.',
        'Камуфляж головы (мужской) 1800 р. 1.5 ч.',
      ...
      services = [
        'Мини мелирование до 10 прядей 2100 р. 2ч...',
        'Мелирование Т-зоны 3550 р. 2.5 ч..',
        'Мелирование половины головы 3750 р. 2.5 ч...',
        'Мелирование всей головы. 5990 р. 3 ч....',
        'Блондирование корней (до 2 см) 2400 р. 1.5 ч.',
        'Блондирование длины. (до 25 см.) 3900 р. 2 ч.',
        'Блондирование длины.. (до 40 см..) 5200 р. 3 ч.',
        'Блондирование длины на фальгу. (до 40 см..) от 6500 р. 3.5 ч..',
        'Блондирование/ 30 гр. пудры 1300 р',
        'Блондирование /90 гр. краситель 3900 р',
        'Сложное окрашивание Matrix AIRTOUCH.... (длина до 25 см.) от 9500 р. 4 ч..',
        'Сложное окрашивание Matrix AIRTOUCH.... (длина до 50 см.) от 11500 р. 4-5 ч..',
        'Сложное окрашивание Matrix AIRTOUCH.... (длина от 50 см.) от 13600 р. 5-6 ч....'
      ];
    ...
    } else if (selectedCategory === 'Уход за руками и стопами') {
      services = [
      ...
      services = [
        'Кератиновое выпрямление и питание фиолетовым составом FASHION STYLIST PLATIUM. (длина волос до 25 см.) 3500 р. 3.ч..',
...
$('#closeTimeSelection').click(function() {
  ...
  $('#bookButton').click(function() {
    var selectedCategory = $('#categoryButton').text();
    var selectedServicesText = $('#selectedServicesList').text();
    var Name = $('#Name').val();
    ...
    var bookingData = {
      ...
      Specialist: selectedSpecialistName,
      name: Name,
      phone: phoneNumber,
      date: selectedDate
    };
